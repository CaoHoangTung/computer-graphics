Question quiz143_148_questions[] = { 
  new Question(
    "8.7a. Look at each number pattern and find the missing number", 
    "4", 
    new TableFigure(
      3, 3, 60, 60, 410, QUESTION_BOX_HEIGHT + PADDING * 4, 0, 0, 10, 
      new String[][] {
        {"4", "3", "10"}, 
        {"5", "2", "8"}, 
        {"7", "?", "26"}
  ...
  new Question(
    ...
    "37,91,6,12,24,36",
    new TableFigure(
      2, 6, 60, 60, 320, QUESTION_BOX_HEIGHT + PADDING * 4, 0, 0, 10, 
      new String[][] {
        {"1", "7", "19", "?", "61", "?"}, 
        {"?", "?", "18", "?", "30", "?"}
      }
  ...
  new Question(
    ...
    "12,23",
    new TableFigure(
      3, 3, 60, 60, 370, QUESTION_BOX_HEIGHT + PADDING * 4, 40, 0, 10, 
      new String[][] {
        {"3", "6", "9"}, 
        {"8", "A", "16"}, 
        {"13", "18", "B"}
  ...
  new Question(
    ...
    "12,9",
    new CircleGraphFigure(
      510, 250, 200, 8, 50, 
      new String[] {"A", "5", "B", "28", "3", "20", "36", "7"}
    )
  ),
  ...
  new Question(
    ...
    new CircleGraphFigure(
      510, 250, 200, 8, 50, 
      new String[] {"12", "6", "A", "42", "B", "30", "7", "18"}
    )
  ),
  ...
  new Question(
    ...
    new CircleGraphFigure(
      510, 250, 200, 8, 50, 
      new String[] {"18", "A", "4", "27", "B", "15", "12", "9"}
    )
  ),
  ...
  new Question(
    ...
    "9",
    new TableFigure(
      3, 3, 60, 60, 410, QUESTION_BOX_HEIGHT + PADDING * 4, 0, 20, 10, 
      new String[][] {
        {"6", "4", "8"}, 
        {"7", "4", "12"}, 
        {"A", "3", "24"}
